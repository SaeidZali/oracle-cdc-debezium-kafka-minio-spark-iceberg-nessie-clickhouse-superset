...
SQLALCHEMY_DATABASE_URI = 'postgresql://root:password@postgres:5432/myapp'
...
LANGUAGES = {"fa": {"flag": "ir", "name": "persian"},
             "en": {"flag": "us", "name": "English"}}
...
DEFAULT_FEATURE_FLAGS: dict[str, bool] = {
    ...
    # @lifecycle: deprecated
    "ENABLE_CROSS_DATABASE_QUERYING":True,
...
THEME_DEFAULT: Theme = {
    "token": {
        ...
        "fontFamilyCode": "'Roboto Mono', 'Courier New', monospace",
        # Extra tokens
...
# This makes Superset recognize the driver
